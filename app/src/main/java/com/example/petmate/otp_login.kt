...
import com.example.petmate.databinding.ActivityOtpLoginBinding
...
class otp_login : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityOtpLoginBinding // Replace with the actual generated binding class
    ...
    private fun sendToMain(){
        startActivity(Intent(this, profileCreationScreen1::class.java))
    }
    ...
    private fun init(){
        ...
        progessBar = binding.otpProgressBar
